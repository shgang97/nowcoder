...
public class RedisConfigTest {
    ...
    public void testHyperLogLog() {
        ...
        size = redisTemplate.opsForHyperLogLog().size(redisKey);
        System.out.println(size);
    }
    ...
    public void testHyperLogLogUnion() {
        ...
        size = redisTemplate.opsForHyperLogLog().size(redisKey3);
        System.out.println(size);
        ...
        size = redisTemplate.opsForHyperLogLog().size(unionKey);
        System.out.println(size);
    }
}